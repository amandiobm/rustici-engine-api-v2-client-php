...
class UpdateDispatchSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['allow_new_registrations'] = $data['allow_new_registrations'] ?? null;
        $this->container['instanced'] = $data['instanced'] ?? null;
        $this->container['registration_cap'] = $data['registration_cap'] ?? null;
