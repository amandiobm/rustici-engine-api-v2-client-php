...
class XapiCredentialAuthTypeSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'xapi_credential_auth_type' => false
    ];
    ...
    public const XAPI_CREDENTIAL_AUTH_TYPE_BASICAUTH = 'BASICAUTH';
    public const XAPI_CREDENTIAL_AUTH_TYPE_OAUTH = 'OAUTH';
    ...
    {
        $this->setIfExists('xapi_credential_auth_type', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($xapi_credential_auth_type)) {
            throw new \InvalidArgumentException('non-nullable xapi_credential_auth_type cannot be null');
        }
        $allowedValues = $this->getXapiCredentialAuthTypeAllowableValues();
        if (!in_array($xapi_credential_auth_type, $allowedValues, true)) {
