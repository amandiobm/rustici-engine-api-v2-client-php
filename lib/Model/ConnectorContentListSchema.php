 ...
 */
class ConnectorContentListSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConnectorContentListSchema';
    ...
    {
        $this->setIfExists('content_entries', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \RusticiSoftware\Engine\V2\Model\ConnectorContentListEntrySchema[]|null
     */
     ...
     *
     * @param \RusticiSoftware\Engine\V2\Model\ConnectorContentListEntrySchema[]|null $content_entries content_entries
     *
     * @return self
     */
    public function setContentEntries($content_entries)
    {
        if (is_null($content_entries)) {
            throw new \InvalidArgumentException('non-nullable content_entries cannot be null');
        }
