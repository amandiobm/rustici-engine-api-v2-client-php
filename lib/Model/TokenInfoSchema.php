 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TokenInfoSchema implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TokenInfoSchema';
     ...
     * Sets expiry
     *
     * @param \DateTime $expiry Expiration of the token.
     *
     * @return $this
     */
     ...
     *
     * @param \RusticiSoftware\Engine\V2\Model\ItemValuePairSchema[] $additional_values Additional values that were included in the token
     *
     * @return $this
     */
