 ...
 */
class ImportAssetRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportAssetRequestSchema';
    ...
    */
     ...
     * Sets destination
     *
     * @param string $destination Path, relative to the course's Content Directory, that indicates where to store the fetched asset file.
     *
     * @return self
     */
