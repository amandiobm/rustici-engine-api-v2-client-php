 ...
 */
class RegistrationListSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RegistrationListSchema';
    ...
    {
        $this->container['registrations'] = $data['registrations'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['registrations'] === null) {
            $invalidProperties[] = "'registrations' can't be null";
        }
