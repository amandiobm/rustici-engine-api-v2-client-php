...
class ImportConnectorRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'connector_id' => false,
        'connector_id_for_content' => false,
        'metadata_for_connector' => false
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('connector_id_for_content', $data ?? [], null);
        $this->setIfExists('metadata_for_connector', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($connector_id_for_content)) {
            throw new \InvalidArgumentException('non-nullable connector_id_for_content cannot be null');
        }
    ...
    {
        if (is_null($metadata_for_connector)) {
            throw new \InvalidArgumentException('non-nullable metadata_for_connector cannot be null');
        }
