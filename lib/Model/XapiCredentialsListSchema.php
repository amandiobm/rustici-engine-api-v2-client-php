 ...
 */
class XapiCredentialsListSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'XapiCredentialsListSchema';
    ...
    {
        $this->setIfExists('xapi_credentials', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($xapi_credentials)) {
            throw new \InvalidArgumentException('non-nullable xapi_credentials cannot be null');
        }
