...
class ActivityResultSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ACTIVITY_COMPLETION_UNKNOWN = 'UNKNOWN';
    public const ACTIVITY_COMPLETION_COMPLETED = 'COMPLETED';
    public const ACTIVITY_COMPLETION_INCOMPLETE = 'INCOMPLETE';
    public const ACTIVITY_SUCCESS_UNKNOWN = 'UNKNOWN';
    public const ACTIVITY_SUCCESS_PASSED = 'PASSED';
    public const ACTIVITY_SUCCESS_FAILED = 'FAILED';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('activity_completion', $data ?? [], null);
        $this->setIfExists('activity_success', $data ?? [], null);
        $this->setIfExists('score', $data ?? [], null);
        $this->setIfExists('time_tracked', $data ?? [], null);
        $this->setIfExists('completion_amount', $data ?? [], null);
        $this->setIfExists('suspended', $data ?? [], null);
        $this->setIfExists('children', $data ?? [], null);
        $this->setIfExists('objectives', $data ?? [], null);
        $this->setIfExists('static_properties', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($activity_completion)) {
            throw new \InvalidArgumentException('non-nullable activity_completion cannot be null');
        }
        $allowedValues = $this->getActivityCompletionAllowableValues();
        if (!in_array($activity_completion, $allowedValues, true)) {
    ...
    {
        if (is_null($activity_success)) {
            throw new \InvalidArgumentException('non-nullable activity_success cannot be null');
        }
        $allowedValues = $this->getActivitySuccessAllowableValues();
        if (!in_array($activity_success, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'activity_success', must be one of '%s'",
                    $activity_success,
    ...
    {
        if (is_null($completion_amount)) {
            throw new \InvalidArgumentException('non-nullable completion_amount cannot be null');
        }
    ...
    {
        if (is_null($static_properties)) {
            throw new \InvalidArgumentException('non-nullable static_properties cannot be null');
        }
