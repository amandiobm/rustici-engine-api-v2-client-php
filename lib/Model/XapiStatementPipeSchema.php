...
class XapiStatementPipeSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['last_forwarded_statement_date'] = $data['last_forwarded_statement_date'] ?? null;
        $this->container['more_url'] = $data['more_url'] ?? null;
        $this->container['attempts'] = $data['attempts'] ?? null;
        $this->container['visible_after'] = $data['visible_after'] ?? null;
