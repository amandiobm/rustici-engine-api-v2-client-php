 ...
 */
class XapiStatementPipeSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'XapiStatementPipeSchema';
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'last_forwarded_statement_date' => false,
        'more_url' => false,
        'attempts' => false,
        'visible_after' => false,
        'source' => false,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('last_forwarded_statement_date', $data ?? [], null);
        $this->setIfExists('more_url', $data ?? [], null);
        $this->setIfExists('attempts', $data ?? [], null);
        $this->setIfExists('visible_after', $data ?? [], null);
        $this->setIfExists('source', $data ?? [], null);
        $this->setIfExists('target', $data ?? [], null);
        $this->setIfExists('local_source', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $last_forwarded_statement_date last_forwarded_statement_date
     *
     * @return self
     */
    public function setLastForwardedStatementDate($last_forwarded_statement_date)
    {
        if (is_null($last_forwarded_statement_date)) {
            throw new \InvalidArgumentException('non-nullable last_forwarded_statement_date cannot be null');
        }
     ...
     * Sets more_url
     *
     * @param string|null $more_url more_url
     *
     * @return self
     */
    ...
    {
        if (is_null($more_url)) {
            throw new \InvalidArgumentException('non-nullable more_url cannot be null');
        }
     ...
     * Sets visible_after
     *
     * @param string|null $visible_after visible_after
     *
     * @return self
     */
    public function setVisibleAfter($visible_after)
    {
        if (is_null($visible_after)) {
            throw new \InvalidArgumentException('non-nullable visible_after cannot be null');
        }
    ...
    public function setLocalSource($local_source)
    {
        if (is_null($local_source)) {
            throw new \InvalidArgumentException('non-nullable local_source cannot be null');
        }
