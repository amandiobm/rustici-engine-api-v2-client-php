...
class LearnerPreferenceSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('audio_level', $data ?? [], null);
        $this->setIfExists('language', $data ?? [], null);
        $this->setIfExists('delivery_speed', $data ?? [], null);
        $this->setIfExists('audio_captioning', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets audio_level
     *
     * @param float|null $audio_level audio_level
     *
     * @return self
     */
    public function setAudioLevel($audio_level)
    {
        if (is_null($audio_level)) {
            throw new \InvalidArgumentException('non-nullable audio_level cannot be null');
        }
     ...
     * Sets delivery_speed
     *
     * @param float|null $delivery_speed delivery_speed
     *
     * @return self
     */
    public function setDeliverySpeed($delivery_speed)
    {
        if (is_null($delivery_speed)) {
            throw new \InvalidArgumentException('non-nullable delivery_speed cannot be null');
        }
    ...
    {
        if (is_null($audio_captioning)) {
            throw new \InvalidArgumentException('non-nullable audio_captioning cannot be null');
        }
