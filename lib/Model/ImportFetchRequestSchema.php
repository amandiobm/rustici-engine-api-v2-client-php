...
class ImportFetchRequestSchema implements ModelInterface, ArrayAccess
{
     ...
     * Sets content_type
     *
     * @param string $content_type MIME type that corresponds to the course content type. Supported types include application/zip, application/pdf, audio/mpeg, and video/mp4. The default value is application/zip.
     *
     * @return $this
     */
