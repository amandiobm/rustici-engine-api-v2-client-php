...
class CourseActivitySchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ACTIVITY_TYPE_UNKNOWN = 'UNKNOWN';
    public const ACTIVITY_TYPE_AGGREGATION = 'AGGREGATION';
    public const ACTIVITY_TYPE_SCO = 'SCO';
    public const ACTIVITY_TYPE_ASSET = 'ASSET';
    public const ACTIVITY_TYPE_OBJECTIVE = 'OBJECTIVE';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('resource_identifier', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($resource_identifier)) {
            throw new \InvalidArgumentException('non-nullable resource_identifier cannot be null');
        }
