 ...
 */
class ConnectorSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConnectorSchema';
    ...
    protected static array $openAPINullables = [
        'connector_id' => false,
        'content_connector_type' => false,
        'configuration' => false,
        'additional_instance_information' => false,
        'enabled' => false
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('content_connector_type', $data ?? [], null);
        $this->setIfExists('configuration', $data ?? [], null);
        $this->setIfExists('additional_instance_information', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $content_connector_type type of this content connector
     *
     * @return self
     */
    public function setContentConnectorType($content_connector_type)
    {
        if (is_null($content_connector_type)) {
            throw new \InvalidArgumentException('non-nullable content_connector_type cannot be null');
        }
     ...
     * Sets configuration
     *
     * @param object|null $configuration configuration for this content connector, format is implementation specific
     *
     * @return self
     */
     ...
     *
     * @param object|null $additional_instance_information additional information about this content connector, format is implementation specific and will only be present if the connector is enabled
     *
     * @return self
     */
    public function setAdditionalInstanceInformation($additional_instance_information)
    {
        if (is_null($additional_instance_information)) {
            throw new \InvalidArgumentException('non-nullable additional_instance_information cannot be null');
        }
     ...
     * Sets enabled
     *
     * @param bool|null $enabled is this connector enabled
     *
     * @return self
     */
