...
class ImportRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['fetch_request'] = $data['fetch_request'] ?? null;
        $this->container['reference_request'] = $data['reference_request'] ?? null;
        $this->container['media_file_reference_request'] = $data['media_file_reference_request'] ?? null;
        $this->container['connector_reference_request'] = $data['connector_reference_request'] ?? null;
        $this->container['ad_hoc_reference_request'] = $data['ad_hoc_reference_request'] ?? null;
        $this->container['lti11_link_reference_request'] = $data['lti11_link_reference_request'] ?? null;
    }
