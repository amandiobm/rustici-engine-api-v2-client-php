 ...
 */
class ImportRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportRequestSchema';
    ...
    protected static array $openAPINullables = [
        ...
        'connector_reference_request' => false,
        'ad_hoc_reference_request' => false,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('reference_request', $data ?? [], null);
        $this->setIfExists('media_file_reference_request', $data ?? [], null);
        $this->setIfExists('connector_reference_request', $data ?? [], null);
        $this->setIfExists('ad_hoc_reference_request', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \RusticiSoftware\Engine\V2\Model\ImportReferenceRequestSchema|null
     */
     ...
     *
     * @param \RusticiSoftware\Engine\V2\Model\ImportReferenceRequestSchema|null $reference_request reference_request
     *
     * @return self
     */
    public function setReferenceRequest($reference_request)
    {
        if (is_null($reference_request)) {
            throw new \InvalidArgumentException('non-nullable reference_request cannot be null');
        }
     ...
     *
     * @return \RusticiSoftware\Engine\V2\Model\ImportConnectorRequestSchema|null
     */
     ...
     *
     * @param \RusticiSoftware\Engine\V2\Model\ImportConnectorRequestSchema|null $connector_reference_request connector_reference_request
     *
     * @return self
     */
    public function setConnectorReferenceRequest($connector_reference_request)
    {
        if (is_null($connector_reference_request)) {
            throw new \InvalidArgumentException('non-nullable connector_reference_request cannot be null');
        }
     ...
     *
     * @return \RusticiSoftware\Engine\V2\Model\ImportAdHocReferenceRequestSchema|null
     */
     ...
     *
     * @param \RusticiSoftware\Engine\V2\Model\ImportAdHocReferenceRequestSchema|null $ad_hoc_reference_request ad_hoc_reference_request
     *
     * @return self
     */
    public function setAdHocReferenceRequest($ad_hoc_reference_request)
    {
        if (is_null($ad_hoc_reference_request)) {
            throw new \InvalidArgumentException('non-nullable ad_hoc_reference_request cannot be null');
        }
