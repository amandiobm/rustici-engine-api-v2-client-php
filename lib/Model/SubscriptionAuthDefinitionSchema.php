...
class SubscriptionAuthDefinitionSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const SUBSCRIPTION_AUTH_TYPE_OAUTH2_CLIENT_CREDENTIALS = 'Oauth2ClientCredentials';
    public const SUBSCRIPTION_AUTH_TYPE_HMACSHA256 = 'HMACSHA256';
    public const SUBSCRIPTION_AUTH_TYPE_HMACSHA512 = 'HMACSHA512';
    public const SUBSCRIPTION_AUTH_TYPE_BASIC = 'Basic';
    ...
    {
        $this->setIfExists('subscription_auth_type', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($subscription_auth_type)) {
            throw new \InvalidArgumentException('non-nullable subscription_auth_type cannot be null');
        }
        $allowedValues = $this->getSubscriptionAuthTypeAllowableValues();
