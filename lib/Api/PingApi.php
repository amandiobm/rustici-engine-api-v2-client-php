...
class PingApi
{
    ...
    {
        list($response) = $this->pingWithHttpInfo($engine_tenant_name);
        return $response;
    }
    ...
    public function pingWithHttpInfo($engine_tenant_name = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RusticiSoftware\Engine\V2\Model\PingSchema' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RusticiSoftware\Engine\V2\Model\PingSchema', []),
     ...
     */
    public function pingAsync($engine_tenant_name = null)
    {
        return $this->pingAsyncWithHttpInfo($engine_tenant_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function pingRequest($engine_tenant_name = null)
    {
