...
class PingApi
{
     ...
     */
    public function ping($engine_tenant_name = null, string $contentType = self::contentTypes['ping'][0])
    {
        list($response) = $this->pingWithHttpInfo($engine_tenant_name, $contentType);
        return $response;
    }
     ...
     */
    public function pingWithHttpInfo($engine_tenant_name = null, string $contentType = self::contentTypes['ping'][0])
    {
        $request = $this->pingRequest($engine_tenant_name, $contentType);
     ...
     */
    public function pingAsync($engine_tenant_name = null, string $contentType = self::contentTypes['ping'][0])
    {
        return $this->pingAsyncWithHttpInfo($engine_tenant_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pingAsyncWithHttpInfo($engine_tenant_name = null, string $contentType = self::contentTypes['ping'][0])
    {
     ...
     */
    public function pingRequest($engine_tenant_name = null, string $contentType = self::contentTypes['ping'][0])
    {
