...
class AboutApi
{
     ...
     */
    public function getUserCount($engine_tenant_name = null, $since = null, $until = null)
    {
        list($response) = $this->getUserCountWithHttpInfo($engine_tenant_name, $since, $until);
        return $response;
    }
     ...
     */
    public function getUserCountWithHttpInfo($engine_tenant_name = null, $since = null, $until = null)
    {
        $returnType = '\RusticiSoftware\Engine\V2\Model\UserCountSummarySchema';
        $request = $this->getUserCountRequest($engine_tenant_name, $since, $until);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserCountAsync($engine_tenant_name = null, $since = null, $until = null)
    {
        return $this->getUserCountAsyncWithHttpInfo($engine_tenant_name, $since, $until)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserCountAsyncWithHttpInfo($engine_tenant_name = null, $since = null, $until = null)
    {
        $returnType = '\RusticiSoftware\Engine\V2\Model\UserCountSummarySchema';
        $request = $this->getUserCountRequest($engine_tenant_name, $since, $until);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getUserCountRequest($engine_tenant_name = null, $since = null, $until = null)
    {
