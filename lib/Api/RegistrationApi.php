...
class RegistrationApi
{
     ...
     */
    public function abandonRegistrationSessionsRequest($engine_tenant_name, $registration_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function buildRegistrationLaunchLinkRequest($engine_tenant_name, $registration_id, $launch_link_request)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createNewRegistrationInstanceRequest($engine_tenant_name, $registration_id)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createRegistrationRequest($engine_tenant_name, $registration, $course_version = null)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if (is_array($course_version)) {
            $course_version = ObjectSerializer::serializeCollection($course_version, '', true);
        }
        if ($course_version !== null) {
            $queryParams['courseVersion'] = $course_version;
        }
        ...
        if (isset($registration)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($registration));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createRegistrationWithLaunchLinkRequest($engine_tenant_name, $create_request, $course_version = null)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($create_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($create_request));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteRegistrationRequest($engine_tenant_name, $registration_id)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteRegistrationConfigurationSettingRequest($engine_tenant_name, $registration_id, $setting_id)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteRegistrationGlobalDataRequest($engine_tenant_name, $registration_id)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteRegistrationInstanceRequest($engine_tenant_name, $registration_id, $instance_id)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteRegistrationInstanceConfigurationSettingRequest($engine_tenant_name, $registration_id, $instance_id, $setting_id)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteRegistrationProgressRequest($engine_tenant_name, $registration_id)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return void
     */
    public function finalizeRegistrationInstanceProgress($engine_tenant_name, $registration_id, $instance_id, $registration_final_state, $activity_id = null)
    {
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function finalizeRegistrationInstanceProgressWithHttpInfo($engine_tenant_name, $registration_id, $instance_id, $registration_final_state, $activity_id = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function finalizeRegistrationInstanceProgressAsync($engine_tenant_name, $registration_id, $instance_id, $registration_final_state, $activity_id = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function finalizeRegistrationInstanceProgressAsyncWithHttpInfo($engine_tenant_name, $registration_id, $instance_id, $registration_final_state, $activity_id = null)
    {
        $returnType = '';
        $request = $this->finalizeRegistrationInstanceProgressRequest($engine_tenant_name, $registration_id, $instance_id, $registration_final_state, $activity_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function finalizeRegistrationInstanceProgressRequest($engine_tenant_name, $registration_id, $instance_id, $registration_final_state, $activity_id = null)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (is_array($activity_id)) {
            $activity_id = ObjectSerializer::serializeCollection($activity_id, '', true);
        }
        if ($activity_id !== null) {
        ...
        if (isset($registration_final_state)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($registration_final_state));
            } else {
     ...
     * @return void
     */
    public function finalizeRegistrationProgress($engine_tenant_name, $registration_id, $registration_final_state, $activity_id = null)
    {
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function finalizeRegistrationProgressWithHttpInfo($engine_tenant_name, $registration_id, $registration_final_state, $activity_id = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function finalizeRegistrationProgressAsync($engine_tenant_name, $registration_id, $registration_final_state, $activity_id = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function finalizeRegistrationProgressAsyncWithHttpInfo($engine_tenant_name, $registration_id, $registration_final_state, $activity_id = null)
    {
        $returnType = '';
        $request = $this->finalizeRegistrationProgressRequest($engine_tenant_name, $registration_id, $registration_final_state, $activity_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function finalizeRegistrationProgressRequest($engine_tenant_name, $registration_id, $registration_final_state, $activity_id = null)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRegistrationRequest($engine_tenant_name, $registration_id)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRegistrationConfigurationRequest($engine_tenant_name, $registration_id, $include_metadata = false, $include_hidden_settings = false, $include_secret_settings = false, $process_replacement_tokens = true)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRegistrationInstanceConfigurationRequest($engine_tenant_name, $registration_id, $instance_id, $include_metadata = false, $include_hidden_settings = false, $include_secret_settings = false, $process_replacement_tokens = true)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getRegistrationInstanceLaunchHistoryWithHttpInfo($engine_tenant_name, $registration_id, $instance_id, $include_history_log = false)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RusticiSoftware\Engine\V2\Model\LaunchHistoryListSchema' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RusticiSoftware\Engine\V2\Model\LaunchHistoryListSchema', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRegistrationInstanceLaunchHistoryRequest($engine_tenant_name, $registration_id, $instance_id, $include_history_log = false)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if (is_array($include_history_log)) {
            $include_history_log = ObjectSerializer::serializeCollection($include_history_log, '', true);
        }
        if ($include_history_log !== null) {
            $queryParams['includeHistoryLog'] = $include_history_log;
        }
    ...
    public function getRegistrationInstanceProgressWithHttpInfo($engine_tenant_name, $registration_id, $instance_id, $include_child_results = false, $include_interactions_and_objectives = false, $include_runtime = false, $create_xapi_registration_id_if_absent = false)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RusticiSoftware\Engine\V2\Model\RegistrationSchema' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RusticiSoftware\Engine\V2\Model\RegistrationSchema', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRegistrationInstanceProgressRequest($engine_tenant_name, $registration_id, $instance_id, $include_child_results = false, $include_interactions_and_objectives = false, $include_runtime = false, $create_xapi_registration_id_if_absent = false)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if (is_array($include_child_results)) {
            $include_child_results = ObjectSerializer::serializeCollection($include_child_results, '', true);
        }
        if ($include_child_results !== null) {
            $queryParams['includeChildResults'] = $include_child_results;
        }
        // query params
        if (is_array($include_interactions_and_objectives)) {
            $include_interactions_and_objectives = ObjectSerializer::serializeCollection($include_interactions_and_objectives, '', true);
        }
        if ($include_interactions_and_objectives !== null) {
            $queryParams['includeInteractionsAndObjectives'] = $include_interactions_and_objectives;
        }
        // query params
        if (is_array($include_runtime)) {
            $include_runtime = ObjectSerializer::serializeCollection($include_runtime, '', true);
        }
        if ($include_runtime !== null) {
            $queryParams['includeRuntime'] = $include_runtime;
        }
        // query params
        if (is_array($create_xapi_registration_id_if_absent)) {
            $create_xapi_registration_id_if_absent = ObjectSerializer::serializeCollection($create_xapi_registration_id_if_absent, '', true);
        }
        if ($create_xapi_registration_id_if_absent !== null) {
            $queryParams['createXapiRegistrationIdIfAbsent'] = $create_xapi_registration_id_if_absent;
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRegistrationInstanceStatementsRequest($engine_tenant_name, $registration_id, $instance_id, $since = null, $until = null, $more = null)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getRegistrationInstancesWithHttpInfo($engine_tenant_name, $registration_id, $since = null, $until = null, $more = null, $include_child_results = false, $include_interactions_and_objectives = false, $include_runtime = false)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RusticiSoftware\Engine\V2\Model\RegistrationListSchema' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RusticiSoftware\Engine\V2\Model\RegistrationListSchema', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRegistrationInstancesRequest($engine_tenant_name, $registration_id, $since = null, $until = null, $more = null, $include_child_results = false, $include_interactions_and_objectives = false, $include_runtime = false)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRegistrationLaunchHistoryRequest($engine_tenant_name, $registration_id, $include_history_log = false)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRegistrationProgressRequest($engine_tenant_name, $registration_id, $include_child_results = false, $include_interactions_and_objectives = false, $include_runtime = false, $create_xapi_registration_id_if_absent = false)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRegistrationStatementsRequest($engine_tenant_name, $registration_id, $since = null, $until = null, $more = null)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRegistrationsRequest($engine_tenant_name, $course_id = null, $learner_id = null, $since = null, $until = null, $more = null, $include_child_results = false, $include_interactions_and_objectives = false, $include_runtime = false)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ltiBasicOutcomesRequest($outcomes_request)
    {
        ...
        if (isset($outcomes_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($outcomes_request));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setRegistrationConfigurationRequest($engine_tenant_name, $registration_id, $configuration_settings)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setRegistrationInstanceConfigurationRequest($engine_tenant_name, $registration_id, $instance_id, $configuration_settings)
    {
        // verify the required parameter 'engine_tenant_name' is set
        if ($engine_tenant_name === null || (is_array($engine_tenant_name) && count($engine_tenant_name) === 0)) {
            throw new \InvalidArgumentException(
