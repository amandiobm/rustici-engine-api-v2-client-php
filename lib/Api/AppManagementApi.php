...
class AppManagementApi
{
     ...
     * @return void
     */
    public function deleteTenantData($tenant_name)
    {
        $this->deleteTenantDataWithHttpInfo($tenant_name);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteTenantDataWithHttpInfo($tenant_name)
    {
        $returnType = '';
        $request = $this->deleteTenantDataRequest($tenant_name);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTenantDataAsync($tenant_name)
    {
        return $this->deleteTenantDataAsyncWithHttpInfo($tenant_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTenantDataAsyncWithHttpInfo($tenant_name)
    {
        $returnType = '';
        $request = $this->deleteTenantDataRequest($tenant_name);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteTenantDataRequest($tenant_name)
    {
        // verify the required parameter 'tenant_name' is set
        if ($tenant_name === null || (is_array($tenant_name) && count($tenant_name) === 0)) {
            throw new \InvalidArgumentException(
