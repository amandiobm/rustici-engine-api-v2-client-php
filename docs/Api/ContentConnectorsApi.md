...
```php
createConnector($connector, $engine_tenant_name): \RusticiSoftware\Engine\V2\Model\StringResultSchema
```
...
```php
getConnectorContentList($engine_tenant_name, $connector_id, $since, $more, $not_imported, $search, $include_all_metadata): \RusticiSoftware\Engine\V2\Model\ConnectorContentListSchema
```
...
```php
getConnectorsList($engine_tenant_name, $include_additional_instance_information): \RusticiSoftware\Engine\V2\Model\ConnectorListSchema
```
...
```php
getRefreshJobStatus($refresh_job_id, $engine_tenant_name): \RusticiSoftware\Engine\V2\Model\RefreshConnectorResultListSchema
```
...
```php
refreshConnectorContentListJob($engine_tenant_name, $connector_id): \RusticiSoftware\Engine\V2\Model\StringResultSchema
```
...
```php
searchRemoteConnectorContent($search_info, $engine_tenant_name): \RusticiSoftware\Engine\V2\Model\ConnectorContentListSchema
```
