...
```php
buildCoursePreviewLaunchLink($engine_tenant_name, $course_id, $launch_link_request): \RusticiSoftware\Engine\V2\Model\LaunchLinkSchema
```
...
```php
buildCoursePreviewLaunchLinkWithVersion($engine_tenant_name, $course_id, $version_id, $launch_link_request): \RusticiSoftware\Engine\V2\Model\LaunchLinkSchema
```
...
```php
createFetchAndImportCourseJob($engine_tenant_name, $course_id, $import_request, $may_create_new_version): \RusticiSoftware\Engine\V2\Model\StringResultSchema
```
...
```php
createUploadAndImportCourseJob($engine_tenant_name, $course_id, $may_create_new_version, $uploaded_content_type, $file, $content_metadata): \RusticiSoftware\Engine\V2\Model\StringResultSchema
```
...
try {
    $result = $apiInstance->createUploadAndImportCourseJob($engine_tenant_name, $course_id, $may_create_new_version, $uploaded_content_type, $file, $content_metadata);
    print_r($result);
} catch (Exception $e) {
...
```php
getCourse($engine_tenant_name, $course_id, $include_registration_count, $include_course_metadata): \RusticiSoftware\Engine\V2\Model\CourseSchema
```
...
```php
getCourseAsset($engine_tenant_name, $course_id, $relative_path): \SplFileObject
```
...
```php
getCourseConfiguration($engine_tenant_name, $course_id, $include_metadata, $include_hidden_settings, $include_secret_settings, $process_replacement_tokens): \RusticiSoftware\Engine\V2\Model\SettingListSchema
```
...
```php
getCourseFileList($engine_tenant_name, $course_id): \RusticiSoftware\Engine\V2\Model\FileListSchema
```
...
```php
getCourseStatements($engine_tenant_name, $course_id, $learner_id, $since, $until, $more): \RusticiSoftware\Engine\V2\Model\XapiStatementResult
```
...
```php
getCourseVersionAsset($engine_tenant_name, $course_id, $version_id, $relative_path): \SplFileObject
```
...
```php
getCourseVersionConfiguration($engine_tenant_name, $course_id, $version_id, $include_metadata, $include_hidden_settings, $include_secret_settings, $process_replacement_tokens): \RusticiSoftware\Engine\V2\Model\SettingListSchema
```
...
```php
getCourseVersionFileList($engine_tenant_name, $course_id, $version_id): \RusticiSoftware\Engine\V2\Model\FileListSchema
```
...
```php
getCourseVersionInfo($engine_tenant_name, $course_id, $version_id, $include_registration_count, $include_course_metadata): \RusticiSoftware\Engine\V2\Model\CourseSchema
```
...
```php
getCourseVersionStatements($engine_tenant_name, $course_id, $version_id, $learner_id, $since, $until, $more): \RusticiSoftware\Engine\V2\Model\XapiStatementResult
```
...
```php
getCourseVersions($engine_tenant_name, $course_id, $since, $until, $include_registration_count, $include_course_metadata): \RusticiSoftware\Engine\V2\Model\CourseListNonPagedSchema
```
...
```php
getCourseZip($engine_tenant_name, $course_id, $export_type): \SplFileObject
```
...
```php
getCourses($engine_tenant_name, $more, $since, $until, $include_registration_count, $include_course_metadata): \RusticiSoftware\Engine\V2\Model\CourseListSchema
```
...
```php
getImportJobStatus($engine_tenant_name, $import_job_id): \RusticiSoftware\Engine\V2\Model\ImportJobResultSchema
```
...
```php
getVersionedCourseZip($engine_tenant_name, $course_id, $version_id, $export_type): \SplFileObject
```
...
```php
importCourseAssetFile($engine_tenant_name, $course_id, $asset_schema, $update_asset_policy): \RusticiSoftware\Engine\V2\Model\AssetFileSchema
```
...
```php
importCourseVersionAssetFile($engine_tenant_name, $course_id, $version_id, $asset_schema, $update_asset_policy): \RusticiSoftware\Engine\V2\Model\AssetFileSchema
```
...
```php
importCourseWithoutUpload($engine_tenant_name, $course_id, $import_request, $may_create_new_version, $dry_run): \RusticiSoftware\Engine\V2\Model\ImportResultSchema
```
...
```php
uploadAndImportCourse($engine_tenant_name, $course_id, $may_create_new_version, $dry_run, $uploaded_content_type, $file, $content_metadata): \RusticiSoftware\Engine\V2\Model\ImportResultSchema
```
...
try {
    $result = $apiInstance->uploadAndImportCourse($engine_tenant_name, $course_id, $may_create_new_version, $dry_run, $uploaded_content_type, $file, $content_metadata);
    print_r($result);
} catch (Exception $e) {
...
```php
uploadCourseAssetFile($engine_tenant_name, $course_id, $destination, $update_asset_policy, $file): \RusticiSoftware\Engine\V2\Model\AssetFileSchema
```
...
```php
uploadCourseVersionAssetFile($engine_tenant_name, $course_id, $version_id, $destination, $update_asset_policy, $file): \RusticiSoftware\Engine\V2\Model\AssetFileSchema
```
